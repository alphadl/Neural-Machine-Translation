...
# Translator.py 2019-06-22 23:18
...
class Translator():
    ...
    def translate_batch(self, src_seq, src_pos):
        ...
        def collect_active_part(beamed_tensor, curr_active_inst_idx, n_prev_active_inst, n_bm):
            '''Collect tensor parts associated to active instance.'''
        ...
        def collate_active_info(
            ...
            # Sentences which are still active are collected, such that the decoder not return on completed sentences.
